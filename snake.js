	...
	snake = {
		...
		drawSnake:function(){
			...
			for(var i=0;i<this.cells.length;i++){
				...
				pen.fillRect(this.cells[i].x*cs,this.cells[i].y*cs,cs-3,cs-3); //(x-coordinate, y co-od, width, height)
			}
		},
		...
		updateSnake:function(){
			...
			this.cells.unshift({x: nextX,y:nextY});  //TO add elements at start and shift to remove element from start
